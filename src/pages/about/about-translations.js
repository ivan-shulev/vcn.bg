const bulgarian = {
    aboutHeader: 'За нас',
    firstRow: 'Компанията е открита през 2008 година. От тогава единствено са наемани нови служители и не спираме да растем!',
    secondRow: 'ВеникомНет е водеща компания за системна интеграция в България с доказан опит, професионални умения и задълбочени познания в областта на безжичните мрежи, системната интеграция и интелигентните сгради.',
