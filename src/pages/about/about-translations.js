const bulgarian = {
    aboutHeader: 'За нас',
    firstRow: 'Компанията е основана през 2008 година. От тогава единствено са наемани нови служители и не спираме да растем!',
    secondRow: '"ВеникомНет" е водеща компания за системна интеграция в България с доказан опит, професионални умения и задълбочени познания в областта на безжичните мрежи, системната интеграция и интелигентните сградни решения.',
...
const english = {
    ...
    firstRow: 'The company was formed in 2008. Since then only new employees have been hired and we keep on growing!',
    secondRow: 'VenicomNet is a leading system integration company in Bulgaria with proven experience, professional skills and in-depth knowledge in the areas of Wireless Networks, System Integration and Intelligent Facilities.',
