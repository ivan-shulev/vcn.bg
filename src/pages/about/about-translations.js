const bulgarian = {
    ...
    secondRow: '"ВеникомНет" е водеща компания за системна интеграция в България с доказан опит, професионални умения и задълбочени познания в областта на интелигентните сградни решения.',
...
const english = {
    ...
    secondRow: 'VenicomNet is a leading system integration company in Bulgaria with proven experience, professional skills and in-depth knowledge in the areas Intelligent Facilities.',
